...
<InteractiveObject>
	...
	<Sprites>
		<Sprite filename="/Sprites/star_seed_ray_note_cranky.sprite" pos="0.8 0" angle="0" gridSize="10 -10" />
		<Sprite filename="/Sprites/star_seed_glow_note.sprite" pos="0 0" angle="0" gridSize="7.61538 -6.9231" />
		<Sprite filename="/Sprites/star_seed_note_1.sprite" pos="0 0" angle="0" gridSize="6.0 -5.19231" />
	...
	<DefaultProperties>
		...
		<Property name="AllowCollect" value="1" />
		<Property name="NumParticlesToHatch" value="3" />
		<Property name="Color" value="183 52 52 255" />
	</DefaultProperties>
</InteractiveObject>
