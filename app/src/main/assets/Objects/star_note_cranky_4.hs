...
<InteractiveObject>
	...
	<Sprites>
		<Sprite filename="/Sprites/star_seed_ray_note_cranky.sprite" pos="0.8 0" angle="0" gridSize="10 -10" visible="false"/>
		<Sprite filename="/Sprites/star_seed_glow_note.sprite" pos="0 0" angle="0" gridSize="7.61538 -6.9231" visible="false" />
		<Sprite filename="/Sprites/star_seed_note_4.sprite" pos="0 0" angle="0" gridSize="6.0 -5.19231" />
	...
	<DefaultProperties>
		...
		<Property name="Color" value="150 198 232 255" />
	</DefaultProperties>
</InteractiveObject>
