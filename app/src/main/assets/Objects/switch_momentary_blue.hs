...
<InteractiveObject>
	...
	<Sprites>
		...
		<Sprite filename="/Sprites/switch_momentary_blue.sprite" pos="0 0" angle="0" gridSize="8 -8" />
		<Sprite filename="/Sprites/switch_momentary_gear_blue.sprite" pos="0 0" angle="0" gridSize="6 -6" />
	</Sprites>
	<DefaultProperties>
